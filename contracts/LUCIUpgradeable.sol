    ...
    UUPSUpgradeable
{
     ...
     * @param to The address to which the initial token supply is allocated.
     */
    function initialize(address to) public initializer {
        __ERC20_init("Lucia Stable Token", "LUCI");
        __Ownable_init();
        __ERC20Permit_init("Lucia Stable Token");
    ...
    function freezeAccount(address account) external onlyOwner {
        require(!_frozen[account], "LUCI: Has been frozen");
    ...
    function unfreezeAccount(address account) external onlyOwner {
        require(_frozen[account], "LUCI: Has been unfrozen");
    ...
    function _beforeTokenTransfer(
        ...
        require(!_frozen[from], "LUCI: Account Frozen");
        ...
        if (from != address(0) && to != address(0)) {
            ...
            if (maxSendAmount > 0) {
                require(
                    ...
                    "LUCI: Transferamount exceeds allowed transfer"
                );
            }
